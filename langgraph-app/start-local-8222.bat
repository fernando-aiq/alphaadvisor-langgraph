@echo off
REM Script para iniciar LangGraph Server localmente na porta 8222

echo ========================================
echo   LangGraph Server - Deploy Local (Porta 8222)
echo ========================================
echo.
...
if not exist ".env" (
    ...
    if exist ".env.example" (
        ...
        echo   - AI_MODEL=gpt-4o (ou outro modelo)
        echo.
        pause
    ) else (
...
echo.
echo Iniciando LangGraph Server na porta 8222...
echo.
echo O servidor será iniciado em: http://localhost:8222
